"""
Report Export Utilities for InterviewIQ.
...
class ReportExporter:
    ...
    def export_csv(report: ReportResponse) -> str:
        ...
        try:
            ...
            # Write header
            writer.writerow(["InterviewIQ Analytics Report"])
    ...
    def export_pdf(report: ReportResponse) -> bytes:
        ...
        try:
            ...
            # Title
            title = Paragraph("InterviewIQ Analytics Report", title_style)
            story.append(title)
...
class ReportTemplate:
    ...
    def get_email_template(report: ReportResponse) -> str:
        ...
        try:
            ...
            <body>
                <div class="header">
                    <h1>InterviewIQ Analytics Report</h1>
                ...
                <div class="footer">
                    <p>This report was generated by InterviewIQ Analytics.</p>
